        ...
        <div id="bg-general">
            <header>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{ route('home') }}"><img class="img-fluid" src="./img/zenetbeaute.png" title="Accueil Zen et beaut&eacute;" alt="Accueil Zen et beaute"></a>
                    ...
                    <div class="collapse navbar-collapse policenature" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link linkStyle2" href="{{ route('home') }}" title="Accueil de Zen et Beauté">Accueil</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle linkStyle2" href="#" title="Nos différentes catégories de prestations" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Nos prestations
                                </a>
                                <div class="dropdown-menu navcategorie" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('massage') }}" title="La carte de massages de Zen et Beaut&eacute;">Massage bien être</a>
                                    <a class="dropdown-item" href="{{ route('epilation') }}" title="Les épilations">Epilation</a>
                                    <a class="dropdown-item" href="{{ route('soins') }}" title="Nos soins du visage">Soins</a>
                                    <a class="dropdown-item" href="{{ route('lipomodelage') }}" title="La cellu m6 de Zen et Beaut&eacute;">Cellu <strong><span style="font-family: 'Livvic', sans-serif;">M6</span></strong></a>
                                    <a class="dropdown-item" href="{{ route('ongles') }}" title="Nos soins mains et pieds">Main\Pied</a>
                                    <a class="dropdown-item" href="{{ route('hammam') }}" title="Nos séance Hammam">Hammam</a>
                                    <a class="dropdown-item" href="{{ route('uv') }}" title="Les UV de Zen et Beaut&eacute;">Séance
                                        <strong><span style="font-family: 'Livvic', sans-serif;">UV</span></strong></a>
                                </div>
                            </li>
                            <li class="nav-iteM">
                                <a class="nav-link linkStyle2" href="{{ route('contact') }}" title="Contacter Zen et Beaut&eacute;">Contact</a>
                            </li>
                            <li class="nav-iteM">
                                <a class="nav-link linkStyle2 policenature" title="La galerie photos de Zen et Beaut&eacute;" href="{{ route('portfolio') }}" />Galerie</a>
                            </li>
                            <li class="nav-iteM">
                                <a class="nav-link linkStyle2 policenature" href="{{ route('chequecadeau') }}" title="Espace membre Zen et Beaut&eacute;">Carte cadeau</a>
                            </li>
                        </ul>
                    </div>
                </nav>
...
<div class="containter col-lg-10 col-md-10 col-sm-12 mx-auto">
    <p class="text-center policesnippet">
        Bienvenue sur le site de <img src="./img/zen_p14.png" width="114" height="12" alt="Selon votre goût soins du corp épilations massage hamman bronzage" title="Selon votre goût soins du corp épilations massage hamman bronzage">.</p>
    <p class="text-center policesnippet"> Selon votre goût : soins du corps épilations massage hamman bronzage</p>
    <p class="text-center policesnippet">
        <h2 class="policesnippet text-center">300 m2 dédiés à la beauté, la détente et au bien-être du corps et de
            l'esprit.</h2>
    </p>
    <p class="text-center policesnippet">
...
<div id="appcard" class="container">
    ...
    <a href="{{ route('ongles') }}">
        <card class="bounceInRight animated" data-image="img/pied_3.jpg">
            ...
            <span class="h4" slot="header">Cliquez</span>
            <p slot="content">
                Vos mains, vos pieds ne sont pas que… des ongles. Nous allons nous en occuper comme nous nous occupons
                de votre visage.
            </p>
        </card>
    </a>
    ...
    <a href="{{ route('soins') }}">
        <card class="bounceInUp animated" data-image="img/produit.jpg">
            ...
            <span class="h4" slot="header">Cliquez</span>
            <p slot="content">
                Un soin du visage destiné à préserver la propreté du visage, à l'embellir, le raffermir, le tonifier ou
                le régénérer.
            </p>
        </card>
    </a>
    <a href="{{ route('chequecadeau') }}" title="Ch&egrave;que cadeau &agrave; offrir ou s'offrir">
...
<div class="container row mx-auto p-0">
    ...
    <div class="item_pub col-lg-3 col-md-4 col-sm-6 text-center">
        <img src="./img/My-spa-logo-2.jpg" alt="massage complet bien etre relaxant pierre chaude" title="Soins : My Spa" />
    </div>
    <div class="item_pub col-lg-3 col-md-4 col-sm-6 text-center">
        <img src="./img/logo-academie.jpg" alt="tensions musculaires massage relaxation detente" title="Soins : Acad&eacute;mie scientifique de beaut&eacute;" />
    </div>
    <div class="item_pub col-lg-3 col-md-4 col-sm-6 text-center">
        <img src="./img/mary_cohr2.jpg" alt="massage minceur couple homme femme enfant" title="Soins : Mary Cohr" />
                ...
                <footer>
                        ...
                        <div class="row">
                            <div class="col-md-3 mx-auto">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2">
                                        <a href="{{ route('massage') }}" class="linkStyle2 couleurverte" title="La carte de massages de Zen et Beauté">Massage Bien être</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="{{ route('epilation') }}" class="linkStyle2" title="Les épilations">Epilation</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="{{ route('soins') }}" class="linkStyle2" title="Nos soins du visage">Soins</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="{{ route('lipomodelage') }}" class="linkStyle2" title="La cellu m6 de Zen et Beauté">Cellu M6</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="{{ route('ongles') }}" class="linkStyle2" title="Nos soins mains et pieds">Mains\Pieds</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="{{ route('uv') }}" class="linkStyle2" title="Les UV de Zen et Beauté">Séance
                                            UV</a>
                                    </li>
                                    <li class="mb-2">
                                        <a href="{{ route('mentionslegales') }}" title="Mentions légales" class="linkStyle2" title="Mentions Légales">Mentions Légales</a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="list-unstyled couleurbleu">
                                    <li>
                                        <p class="policesnippet2">Par Téléphone <br>
                                            <a href="tel:+33494493653" class="linkStyle2" title="Notre téléphone">04.94.49.36.53</a></p>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/Zen-ET-Beaute-246867908832349/"><img class="logofooter1" src="./img/logofacebook.jpg" alt="Facebook Zen et Beauté" title="La page Facebook de Zen et Beauté"></a>
                                    </li>
                                    <br>
                                    <li>
                            ...
                            <div class="col-lg-3 col-md-12 mx-auto">
                                <img class="logofooter2" src="./img/zenetbeaute.png" alt="logo zen et beauté" title="Institut de beauté Sainte-Maxime">
                                <a href="https://goo.gl/maps/cbQ4PvEEq8ERSJka8">
                                    <img class="logofooter mt-4" src="./img/devanture.JPG" alt="Zen et Beauté 83120 Sainte-Maxime" title="Nous situer">
                                </a>
                    ...
                    <div class="text-center py-3 policesnippet2">© 2019 Design :
                        <a href="https://www.360-visio.fr" class="policesnippet2 linkStyle2" title="Visitez le site de 360 Visio">360 Visio</a>
